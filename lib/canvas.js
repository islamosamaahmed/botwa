...
const { flamming, dynamic, estetik } = JSON.parse(
  readFileSync("./database/image.json"),
);
const imgSource = [
  "https://api.btstu.cn/sjbz/api.php?lx=1920x1080",
  "https://img.xjh.me/random_img.php?type=bg&ctype=acg&return=302&device=web",
  "https://minimalistic-wallpaper.demolab.com/?random",
  "https://www.loremflickr.com/1920/1080",
  "https://www.picsum.photos/1920/1080",
  "https://www.placebear.com/1920/1080",
  "https://www.placebeard.it/1920/1080",
];
class ImageEditor {
  constructor(
    bgImageURL,
...
function OTP(Cods) {
  return pickRandom([
    `https://dummyimage.com/300.png/09f/fff&text=${(Cods = encodeURIComponent(Cods))}`,
