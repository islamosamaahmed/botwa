async function blackboxChat(content) {
  ...
  const data = {
    ...
    isMicMode: false,
    userSystemPrompt:
      "You are Dark Box, a useful AI Model for millions of developers using Blackbox Code Chat that will answer coding questions and help them when writing code.",
    maxTokens: 1024,
    webSearchMode: false,
    promptUrls: "",
    isChromeExt: false,
