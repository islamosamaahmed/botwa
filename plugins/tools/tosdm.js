  ...
  try {
    ...
    try {
      ...
      const response = await axios.get(
        `https://api-faa-skuarta2.vercel.app/faa/tosdmtinggi?url=${encodeURIComponent(imageUrl)}`,
...
handler.help = ["tosdm", "tosdmtinggi"].map(a => a + " *[reply/send media]*")
handler.tags = ["tools"]
handler.command = ["tosdm", "tosdmtinggi"]
handler.limit = true
